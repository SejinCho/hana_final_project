            ...
            <div id="content">
            	...
            	<input type="hidden" name="kakao_id" value="${kakao_id}">
	                ...
	                <div>
	                    ...
	                    <span>
	                    	<input type="radio" id="receive_sms_yn" name="receiveKakaoYn" value="Y" > <label for="name">수신</label>
	                    	<input type="radio" id="receive_sms_yn" name="receiveKakaoYn" value="N"> <label for="name">수신 거부</label>
	                    </span>
	                    <span class="error_next_box"></span>
	                </div>
