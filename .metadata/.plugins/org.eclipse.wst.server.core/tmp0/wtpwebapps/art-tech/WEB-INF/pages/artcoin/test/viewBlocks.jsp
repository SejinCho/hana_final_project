...
<head>
    ...
    <!-- Datatable -->
    <link href="${pageContext.request.contextPath}/static/css/vendor/datatables/css/jquery.dataTables.min.css" rel="stylesheet">
    <!-- Custom Stylesheet -->
...
<body>
                ...
                <div class="row page-titles mx-0">
                    <div class="col-sm-6 p-md-0">
                        <div class="welcome-text">
                            <h4>Total of 13,031,411 blocks</h4>
                                    ...
                                    <table id="example" class="display" style="min-width: 845px">
                                        ...
                                        <tbody>
                                            <tr>
                                                ...
                                                <td><a href="${pageContext.request.contextPath}/artscan/viewTxns">Edinburgh</a></td>
                                                <td>61</td>
                                                <td>2011/04/25</td>
                                                <td>$320,800</td>
                                            </tr>
    ...
    ***********************************-->
    ...
    <!-- Datatable -->
    <script src="${pageContext.request.contextPath}/static/css/vendor/datatables/js/jquery.dataTables.min.js"></script>
    <script src="${pageContext.request.contextPath}/static/js/artcoin/plugins-init/datatables.init.js"></script>
